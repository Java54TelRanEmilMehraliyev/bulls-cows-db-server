...
public class RepositoryTest {
	...
	void gameNotFoundTest() {
		assertThrowsExactly(GameNotFoundException.class, () -> repository.getGame(1000));
	}

	@Test
	void gamerNotFoundTest() {
		assertThrowsExactly(GamerNotFoundException.class, () -> repository.getGamer("kuku"));
	}
	...
	void GameGamerNotFoundTest() {
		assertThrowsExactly(GameGamerNotFoundException.class,
				() -> repository.createGameGamerMove(new MoveDto(1000l, gamerUsername, "1243", 2, 2)));
	}
